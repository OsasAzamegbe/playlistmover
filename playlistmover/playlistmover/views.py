...
class PlaylistApiView(APIView):
    """
    API View to manage retrieving and creating playlists from third-party music platforms for the caller.
    Playlist retrieval done through the GET HTTP method.
    Playlist creation done through the POST HTTP method.
